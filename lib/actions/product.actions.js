...
// Helper to clean Firestore data for Next.js serialization
const serializeDoc = (doc) => {
    ...
    return {
        id: doc.id,
        ...data,
        // Convert all known timestamps to ISO strings
...
export const getCategoryProductsAction = async (categorySlug) => {
