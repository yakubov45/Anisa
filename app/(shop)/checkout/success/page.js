...
export default function OrderSuccessPage() {
    ...
    const handleOperatorClick = (e) => {
        e.preventDefault();
        window.open("https://t.me/Nurafshon_OnePC", "_blank");
    };
    ...
    return (
        <div className="min-h-[60vh] flex flex-col items-center justify-center text-center space-y-6 md:space-y-8 animate-fade-in px-4 relative pt-10">
            ...
            <div className="flex flex-col sm:flex-row gap-3 md:gap-4 w-full max-w-md mt-4">
                <button onClick={handleOperatorClick} className="flex-1 bg-[#229ED9] text-white font-black px-6 py-4 rounded-xl shadow-[0_10px_20px_rgba(34,158,217,0.3)] hover:bg-[#1c84b5] transition-all uppercase text-[9px] tracking-widest active:scale-95 flex items-center justify-center gap-2">
            ...
            {isModalOpen && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 overflow-y-auto">
                    ...
                    <motion.div
                        ...
                        className="relative w-full max-w-sm bg-white dark:bg-[#0c0c0e] border border-black/10 dark:border-white/10 rounded-[2rem] p-6 md:p-8 shadow-2xl flex flex-col items-center text-center overflow-hidden max-h-[90vh] my-auto z-10"
                    >
