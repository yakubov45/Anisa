            ...
            <div className="container mx-auto px-4 md:px-6 relative z-10">
                ...
                <div className="flex items-center gap-6 mb-12">
                    <Link href="/pc-builder" className="group flex items-center gap-3">
                        <div className="w-8 h-8 rounded-lg bg-surface-100 flex items-center justify-center group-hover:bg-primary group-hover:text-white transition-all">
                ...
                <div className="flex flex-col lg:flex-row gap-16 lg:gap-24 items-center lg:items-start">
                    ...
                    <div className="w-full lg:w-5/12 space-y-10">
                        <div className="relative aspect-square border border-border-alpha rounded-[3rem] p-10 flex items-center justify-center overflow-hidden shadow-sm group mx-auto max-w-sm lg:max-w-none">
                            ...
                            <div className="absolute top-8 left-8 flex flex-col gap-3">
                                <div className="bg-primary/10 backdrop-blur-md border border-primary/20 text-primary text-[9px] font-black px-5 py-2 rounded-lg uppercase tracking-widest shadow-xl">
                                    Certified Stable v4.2
                                </div>
                                <div className="bg-foreground/5 backdrop-blur-md border border-foreground/10 text-foreground text-[9px] font-black px-5 py-2 rounded-lg uppercase tracking-widest">
                                    Strategic Build
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex justify-center">
                            <div className="bg-transparent border border-border-alpha px-8 py-6 rounded-2xl text-center space-y-1 min-w-[160px]">
                    ...
                    <div className="w-full lg:w-7/12 space-y-12">
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                {specsArray.map((spec, i) => (
                                    <div key={i} className="flex items-center gap-5 p-5 bg-transparent rounded-2xl border border-border-alpha hover:border-primary/40 transition-all group cursor-default">
                                        <div className="w-12 h-12 bg-surface-100 rounded-xl flex items-center justify-center text-primary font-black shadow-sm group-hover:bg-primary group-hover:text-white transition-all text-xs">
                                            {i + 1 < 10 ? `0${i + 1}` : i + 1}
                                        </div>
                        ...
                        <div className="pt-10 border-t border-border-alpha flex flex-col sm:flex-row items-center justify-between gap-8">
                            ...
                            <button className="w-full sm:w-auto bg-foreground text-background font-black text-[11px] uppercase tracking-[0.3em] px-16 py-6 rounded-2xl hover:bg-primary hover:text-white hover:scale-105 active:scale-95 transition-all shadow-premium group flex items-center justify-center gap-4">
                                BUY NOW
                                <svg className="w-4 h-4 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" d="M14 5l7 7-7 7M3 12h18" /></svg>
                            </button>
                        </div>
                    </div>
                </div>
