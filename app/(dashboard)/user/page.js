        ...
        <div className="space-y-10">
            <div className="bg-primary rounded-3xl p-12 text-white relative overflow-hidden group">
                ...
                <div className="relative z-10 space-y-4">
                    <h1 className="text-4xl font-black tracking-tighter">Hello, {user?.name?.split(' ')[0] || "Friend"}!</h1>
                    <p className="font-medium opacity-90 max-w-sm">From your dashboard you can view your recent orders, manage your shipping addresses, and edit your profile details.</p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center font-bold">
                <div className="bg-surface p-10 rounded-3xl shadow-premium border border-surface-50 space-y-4 group cursor-pointer hover:-translate-y-1 transition-all">
                    ...
                    <p className="text-surface-900">Recent Orders</p>
                </div>
                <div className="bg-surface p-10 rounded-3xl shadow-premium border border-surface-50 space-y-4 group cursor-pointer hover:-translate-y-1 transition-all">
                    <div className="w-12 h-12 mx-auto text-primary group-hover:scale-110 transition-transform">
                    ...
                    <p className="text-surface-900">Account Settings</p>
                </div>
                <div className="bg-surface p-10 rounded-3xl shadow-premium border border-surface-50 space-y-4 group cursor-pointer hover:-translate-y-1 transition-all">
                    <div className="w-12 h-12 mx-auto text-primary group-hover:scale-110 transition-transform">
                    ...
                    <p className="text-surface-900">Your Wishlist</p>
                </div>
            </div>
        </div>
    );
