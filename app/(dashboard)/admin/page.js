    ...
    useEffect(() => {
        const fetchStats = async () => {
            try {
                ...
                const totalRevenueUSD = orders.reduce((acc, o) => {
                    const amt = Number(o.totalAmount || o.total || 0);
                    const isUzs = amt > 100000;
                    const usdValue = isUzs ? amt / exchangeRate : amt;
                    return acc + usdValue;
                }, 0);
                ...
                setStats([
                    ...
                    { label: t('admin_total_revenue'), value: formatPrice(totalRevenueUSD, currency, exchangeRate), growth: t('admin_life_time'), icon: <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg> },
                ]);
            } catch (error) {
                ...
                <div className="bg-surface p-10 rounded-[2.5rem] shadow-premium border border-surface-50 space-y-8">
                    ...
                    <div className="space-y-4">
                        {[
                            ...
                            { label: "Brendlar", href: "/admin/brands", icon: <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 2l2 6h6l-5 4 2 6-5-4-5 4 2-6-5-4h6z"/></svg>, color: "bg-surface-100 text-surface-900 shadow-sm" },
