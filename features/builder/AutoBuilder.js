        ...
        <div className="bg-zinc-900 border border-white/5 rounded-3xl md:rounded-[2.5rem] p-6 md:p-12 space-y-8 md:space-y-10 relative overflow-hidden group">
            ...
            <div className="relative flex flex-col md:flex-row md:items-end justify-between gap-8">
                <div className="space-y-2">
                    ...
                    <p className="text-zinc-500 font-medium text-sm max-w-xl">Save your time! Tell us what you need your PC for, and our intelligent engine will select the optimal components for your workflow.</p>
                </div>
