...
export default function BuilderGuide() {
    const steps = [
        {
            title: "01. Define Mission",
            desc: "Identify your primary objective: Gaming, Professional Rendering, or Enterprise Productivity.",
            icon: <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/></svg>
        },
        {
            title: "02. Core Selection",
            desc: "Select your CPU - the central nervous system. High-performance processors accelerate complex execution.",
        ...
        },
        {
            ...
            desc: "Our intelligence engine automatically validates all component cross-compatibility protocols.",
        ...
        {
            title: "04. Memory Throughput",
            desc: "RAM and SSD configuration determine the overall responsiveness and data speed of your system.",
    ...
    return (
        <div className="bg-surface-50 border border-border-alpha rounded-[3rem] p-6 lg:p-20 space-y-12">
            <div className="max-w-2xl space-y-4">
                ...
                <h2 className="text-2xl lg:text-4xl font-black text-foreground tracking-tighter uppercase">PC Assembly Protocol</h2>
                <p className="text-surface-500 text-xs font-medium">If you are new to custom system architecture, follow these streamlined operational steps to build your ideal machine.</p>
            </div>
            ...
            <div className="pt-8 border-t border-border-alpha flex flex-col md:flex-row items-center justify-between gap-6">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h5 className="text-xs font-black text-foreground uppercase tracking-widest">Certified Compatibility</h5>
